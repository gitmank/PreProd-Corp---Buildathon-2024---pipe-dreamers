...
def clean_data(file_path, remove_features, numerical_features, categorical_features, encoding_type='onehot', 
               target_feature=None, outlier_method='iqr', impute_strategy='knn', normalize_method='standard', 
               chunksize=None):
    ...
    print("\nRemoved features:", ', '.join(remove_features))
    ...
    print(f"\nConverted the following categorical features to numeric using {encoding_type} encoding: {', '.join(categorical_features)}")
    print(f"\nNumerical features (unchanged): {', '.join(numerical_features)}")
...
def save_clean_data(file_path, remove_features, numerical_features, categorical_features, output_dir, encoding_type='onehot', 
    ...
    try:
        ...
        cleaned_df = clean_data(file_path, remove_features, numerical_features, categorical_features, encoding_type, target_feature, 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--numerical_features', nargs='+', help="List of features to treat as numerical.")
    parser.add_argument('--categorical_features', nargs='+', help="List of features to treat as categorical.")
